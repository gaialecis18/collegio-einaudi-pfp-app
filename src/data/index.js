...
export const COURSES = [
  {
    ...
    professorTitle: 'Seminar Professor @ UniTo',
    enrolled: 16,
    rating: 4.8,
    duration: '12 hours',
  ...
  },
  {
    ...
    professor: 'Dr. Erika Bloom',
    professorTitle: 'Art History Professor',
    enrolled: 12,
    rating: 4.8,
    duration: '10 hours',
    location: 'Pinacoteca',
  ...
  },
  {
    ...
    professor: 'Dr. Lorenzo Verde',
    professorTitle: 'Sustainability Researcher',
    enrolled: 20,
    rating: 4.7,
    duration: '12 hours',
    location: 'Lab Scientifico',
  ...
  },
  {
    ...
    professor: 'Dr. Fabrizio Landi',
    professorTitle: 'Quantum Physics @ PoliTo',
    enrolled: 15,
    rating: 4.8,
    duration: '18 hours',
    location: 'Laboratorio Fisica',
...
export const NOTIFICATIONS = [
  ...
  },
  {
    ...
    message: 'Enrollment is now open for Ethics in Artificial Intelligence by Prof. Marco.',
    time: 'Yesterday',
    isToday: false,
    icon: 'book',
    color: '#C0272D',
    ...
    detailSubtitle: 'Ethics in Artificial Intelligence by Prof. Marco',
  },
];
